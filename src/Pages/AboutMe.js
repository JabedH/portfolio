    ...
    <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 px-12 mt-40">
      ...
      <div className="grid content-center ">
        ...
        <h3 className="text-base w-96 mt-5">
          I’m Md Jabed Hossain Tusar, a junior web Developer. I honed my skills
          at web development. I develop websites with HTML, CSS, JavaScript and
          React. I have top skills in using Web Developing like HTML, CSS,
          JavaScript, ES6, React, Tailwind CSS, Bootstrap and PhotoShop; with
          familiar tools like GitHub, VS Code, Heroku, Netlify , Figma, Chrome
          Dev Tools, etc.
        </h3>
        <h3 className="text-base w-96 mt-5">
